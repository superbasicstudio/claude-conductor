...
async function initializeFramework(targetDir, options) {
  ...
  console.log(
    chalk.green("|") +
      chalk.green.bold(" DEFAULT: Core templates only          ") +
      chalk.green("|")
  );
  console.log(chalk.green("+---------------------------------------+"));
  ...
  console.log(
    chalk.blue("|") + chalk.blue.bold(" FULL: All 14 documentation templates  ") + chalk.blue("|")
  );
  console.log(chalk.blue("+---------------------------------------+"));
  ...
  console.log(
    chalk.yellow("|") +
      chalk.yellow.bold(" DEEPSCAN: Comprehensive analysis      ") +
      chalk.yellow("|")
  );
  console.log(chalk.yellow("+---------------------------------------+"));
  ...
  console.log(
    chalk.red("|") + chalk.red.bold(" FORCE: Overwrites all files           ") + chalk.red("|")
  );
  console.log(chalk.red("+---------------------------------------+"));
  ...
  console.log("");
  const claudeMdSkipped = await copyTemplates(
    templatesDir,
    targetPath,
    options.force,
    options.full,
  ...
  if (!options.yes) {
    ...
    console.log(
      chalk.cyan("│") +
        " " +
        chalk.cyan.bold("🪄 Would you like Conductor to perform a security checkup?") +
        "       " +
        chalk.cyan("│")
    );
    console.log(chalk.cyan("├─────────────────────────────────────────────────────────────────┤"));
    console.log(
      chalk.cyan("│") +
        " This will generate a prompt for Claude Code to audit your       " +
        chalk.cyan("│")
    );
    console.log(
      chalk.cyan("│") +
        " codebase for common security issues. No files will be changed.  " +
        chalk.cyan("│")
    );
    console.log(chalk.cyan("└─────────────────────────────────────────────────────────────────┘"));
    console.log("");
  ...
  console.log(
    chalk.yellow("│") +
      " " +
      chalk.yellow.bold("⚠️  RECOMMENDED NEXT STEP") +
      "                                       " +
      chalk.yellow("│")
  );
  console.log(chalk.yellow("├─────────────────────────────────────────────────────────────────┤"));
  console.log(
    chalk.yellow("│") +
      " To populate your documentation with actual project details,     " +
      chalk.yellow("│")
  );
  console.log(
    chalk.yellow("│") +
  ...
  console.log(
    chalk.yellow("│") +
      chalk.cyan('  "Please review this codebase and update the CLAUDE.md') +
      "         " +
      chalk.yellow("│")
  );
  ...
  if (userChoseSecurityCheckup && !options.yes) {
    ...
    console.log(
      chalk.yellow("│") +
        chalk.cyan('   and CONDUCTOR.md files with the actual project details."') +
        "     " +
        chalk.yellow("│")
    );
  } else {
    ...
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   Also perform a security health check and list any") +
        "            " +
        chalk.yellow("│")
    );
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   potential vulnerabilities or concerns (like exposed") +
        "          " +
        chalk.yellow("│")
    );
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   .env files, API keys in code, missing .gitignore") +
        "            " +
        chalk.yellow("│")
    );
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   entries, outdated dependencies with known vulnerabilities,") +
        "   " +
        chalk.yellow("│")
    );
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   or insecure configurations) - just list them as warnings,") +
        "   " +
        chalk.yellow("│")
    );
    console.log(
      chalk.yellow("│") +
        chalk.cyan("   don't fix anything.\"") +
        "                                          " +
        chalk.yellow("│")
    );
  }
  ...
  console.log(
    chalk.yellow("│") +
      " This one-time setup ensures your docs match your project! 🚀   " +
      chalk.yellow("│")
  );
  console.log(chalk.yellow("└─────────────────────────────────────────────────────────────────┘"));
  console.log("");
  ...
  if (claudeMdSkipped && !options.force) {
    ...
    console.log(
      chalk.blue("│") +
        " " +
        chalk.blue.bold("ℹ️  EXISTING CLAUDE.md DETECTED") +
        "                                  " +
        chalk.blue("│")
    );
    console.log(chalk.blue("├─────────────────────────────────────────────────────────────────┤"));
    console.log(
      chalk.blue("│") +
        " Your existing CLAUDE.md was preserved. To work optimally with   " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        " Claude Conductor, please add this section to your CLAUDE.md:    " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
    ...
    console.log(
      chalk.blue("│") +
        chalk.white(" ## Journal Update Requirements") +
        "                                  " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        chalk.white(" **IMPORTANT**: Update JOURNAL.md regularly throughout our work") +
        "  " +
        chalk.blue("│")
    );
    console.log(
    ...
    console.log(
      chalk.blue("│") +
        chalk.white(" - After completing any significant feature or fix") +
        "               " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        chalk.white(" - When encountering and resolving errors") +
        "                       " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        chalk.white(" - At the end of each work session") +
        "                              " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        chalk.white(" - When making architectural decisions") +
        "                          " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
        chalk.white(" - Format: What/Why/How/Issues/Result structure") +
        "                 " +
        chalk.blue("│")
    );
    console.log(
    ...
    console.log(
      chalk.blue("│") +
        " This ensures Claude maintains a detailed development history! 📝 " +
        chalk.blue("│")
    );
    console.log(
      chalk.blue("│") +
    ...
    console.log(
      chalk.blue("│") +
        chalk.gray(" For security checkups, use: npx claude-conduct checkup 🪄") +
        "       " +
        chalk.blue("│")
    );
    console.log(chalk.blue("└─────────────────────────────────────────────────────────────────┘"));
  ...
  console.log(
    chalk.gray("    See: ") +
      chalk.blue.underline(
        "https://github.com/superbasicstudio/claude-conductor/blob/main/THANKS.md"
      )
  );
  console.log("");
}
...
async function updateArchitectureMd(targetPath, analysis, newlyCreatedFiles, force) {
  ...
  content = content.replace(/## Tech Stack[\s\S]*?(?=##|$)/, techStackDetail + "\n");
...
async function updateBuildMd(targetPath, analysis, newlyCreatedFiles, force) {
  ...
  if (analysis.buildScripts && Object.keys(analysis.buildScripts).length > 0) {
    ...
    if (content.includes("## Available Scripts")) {
      content = content.replace(/## Available Scripts[\s\S]*?(?=##|$)/, scriptsSection);
    } else {
      content += "\n" + scriptsSection;
    }
...
async function generateCheckupPrompt(options) {
  ...
  console.log(
    chalk.magenta("│") +
      " " +
      chalk.magenta.bold("🪄 Conductor Security & Health Checkup") +
      "                           " +
      chalk.magenta("│")
  );
  console.log(chalk.magenta("└─────────────────────────────────────────────────────────────────┘"));
...
Start the checkup with: "Conductor🪄 is running a security checkup..."`;
  ...
  console.log(
    chalk.yellow("│") +
      " " +
      chalk.yellow.bold("📋 Copy this prompt to Claude Code:") +
      "                              " +
      chalk.yellow("│")
  );
  console.log(chalk.yellow("├─────────────────────────────────────────────────────────────────┤"));
...
async function createUserBackup(targetPath) {
  ...
  try {
    ...
    throw new Error(`Cannot create backup directory: ${error.message}`, { cause: error });
  }
...
async function upgradeClean(targetPath, options) {
  ...
  if (!options.yes) {
    ...
    console.log("");
    console.log(
      chalk.yellow("This will DELETE all Conductor files and reinstall fresh templates.")
    );
    if (hasBackup) {
    ...
    const confirmed = await promptConfirmation(
      chalk.yellow("Continue with clean reinstall? (y/N): ")
    );
    if (!confirmed) {
